  ...
  render() {
    ...
    return (
      <Layout title='Bills | Plans'>
        <section
          style={{ paddingTop: 100, paddingLeft: "5rem", paddingRight: "5rem" }}
          className='section-rt'
        >
                  ...
                  <div className='row justify-content-center'>
                    <div className='col-sm-12 px-0'>
                      <div className='d-flex'>
                        <div className='rt-title-text mb-3'>
                          <span className='text-dark'>Plans for </span>
                ...
                <div className='row'>
                  ...
                  <div className='col-md-2'>
                    <Link route={`/bills/${this.props.address}/plans/new`}>
                      <a>
                        <Button className='btn-rt semantic success py-4'>
                          Create Plan
                        </Button>
                      </a>
                    </Link>
